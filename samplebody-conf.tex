...
\newline
\indent\textbf{Senti4SD:} This tool is a result of a recent paper~\cite{calefato2017sentiment} which also classifies each text by labeling their sentiment as positive, negative or neutral. The tool was built
from scratch using questions, answers and comments from StackOverflow as its training data. Hence it has the claim to be of closer relevance to Software Engineering domain.
\newline
\newline
