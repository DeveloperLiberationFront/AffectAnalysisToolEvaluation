...
The drop in the performance perhaps 
is not that surprising 
as we now added the comments 
that the human raters initially disagreed on between them. 
It indicates that these comments are harder to measure 
due to subtle subjectivity.
%and there remain subtle aspects of subjectivity in these comments. 
However, the tools' performance 
over both the final and full dataset 
